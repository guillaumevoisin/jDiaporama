(function($){
	...
	var jDiaporama = function(elt, options)
	{
		...
		topParent = diapo.parent().parent().parent();
		...
		this.iniMouseActions = function()
		{
			...
			diapo.parent().parent().mouseenter(function(){
				if(!mouseover)
				{
					mouseover = true;
		...
		this.initControls = function()
		{
			...
			$(".prev", topParent).click(function(ev){
				ev.preventDefault();
			...
			$(".next", topParent).click(function(ev){
				ev.preventDefault();
			...
			$(".pauseBtn", topParent).click(function(){
				diapoObj.pauseSlider();
		...
		this.init = function()
		{
			...
			diapo.parent().width(this.options.width).parent().width(this.options.width).parent().width(this.options.width);
			...
			if(this.options.status_controls)
			{
				...
				$("#jDiaporama_bullet_"+(parseInt($("li", diapo).index($("li:first-child", diapo)))+1), topParent).addClass("active");
				$(".jDiaporama_status", topParent).show();
			}
			
			if(this.options.auto && this.options.paused)
				$(".pauseBtn", diapo.siblings()).trigger("click");
		...
		{					
			...
			else if(effect == "sliceHide" || effect == "slice" || effect == "sliceBarsVFade" || effect == "sliceBarsVAlternate" || effect == "sliceBarsV" || effect == "sliceBarsHAlternate" || effect == "sliceBarsH")
			{
				...
				if(effect == "slice" || effect == "sliceHide")
				{
					...
					slices.each(function(i, elt){
						...
						{
							if(effect == "sliceHide")
								setTimeout(function(){ $(elt).hide("fast", function(){ $(this).remove(); $(".fade-tmp").remove(); diapo.trigger("jDiaporama:animationEnds") }) }, (timeout));
							else
								setTimeout(function(){ $(elt).fadeOut("fast", function(){ $(this).remove(); $(".fade-tmp").remove(); diapo.trigger("jDiaporama:animationEnds") }) }, (timeout));
						}
						else
						{
							if(effect == "sliceHide")
				...
				else if(effect == "sliceBarsH")
				{
					...
					slices.each(function(i, elt){
						if(i == (diapoObj.options.nbSlices)-1)
						{
							setTimeout(function(){ $(elt).animate({height: 0, opacity:0}, function(){ $(this).remove(); $(".fade-tmp").remove(); diapo.trigger("jDiaporama:animationEnds") }) }, (timeout));
						}
						else
				...
				else if(effect == "sliceBarsV")
				{
					...
					slices.each(function(i, elt){
						if(i == (diapoObj.options.nbSlices)-1)
						{
							setTimeout(function(){ $(elt).animate({width: 0, opacity:0}, function(){ $(this).remove(); $(".fade-tmp").remove(); diapo.trigger("jDiaporama:animationEnds") }) }, (timeout));
						}
						else
				...
				else if(effect == "sliceBarsVFade")
				{
					...
					slices.each(function(i, elt){
						if(i == (diapoObj.options.nbSlices)-1)
						{
							setTimeout(function(){ $(elt).animate({width: 0, opacity:0}, 650, function(){ $(this).remove(); $(".fade-tmp").remove(); diapo.trigger("jDiaporama:animationEnds") }) }, (timeout));
						}
						else
			...
			{
				diapo.stop().animate({left: -((id-1)*diapoObj.options.width)}, diapoObj.options.animationSpeed, function(){ diapo.trigger("jDiaporama:animationEnds") });
			}
			...
			else if(effect == "slidev")
			{
				...
				$(".fade-tmp").width(diapoObj.options.width).animate({top:-diapoObj.options.height}, diapoObj.options.animationSpeed, function(){ $(this).remove(); diapo.trigger("jDiaporama:animationEnds") });
			...
			{
				diapo.stop().css("left", -((id-1)*diapoObj.options.width)); diapo.trigger("jDiaporama:animationEnds");
			}
			...
			if(this.options.status_controls)
				$("#jDiaporama_bullet_"+id, topParent).addClass("active");
