(function($){
	...
	var jDiaporama = function(elt, options)
	{
		...
		{					
			...
			{
				diapo.stop().animate({left: -((id-1)*diapoObj.options.width)}, diapoObj.options.animationSpeed, diapoObj.options.animationEasing, function(){ diapo.trigger("jDiaporama:animationEnds") });
			}
			...
			else if(effect == "slidev")
			{
				...
				diapo.stop().css({top: diapoObj.options.height, left: -((id-1)*diapoObj.options.width)}).animate({top:0}, diapoObj.options.animationSpeed, diapoObj.options.animationEasing );
