(function($){
	...
	var jDiaporama = function(elt, options)
	{
		...
		this.nextImage = function(options, elt)
		{
			...
			else if(effect == "sliceHide" || effect == "slice" || effect == "sliceBarsVFade" || effect == "sliceBarsVAlternate" || effect == "sliceBarsV" || effect == "sliceBarsHAlternate" || effect == "sliceBarsH" || effect == "slidevInverse" || effect == "slidev" || effect == "slide" || effect == "slideDiago")
			{
				if($(".fade-tmp"))
					$(".fade-tmp").remove();
